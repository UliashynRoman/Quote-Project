...
function newTweet(e) {
     ...
     const topic = document.getElementById('topic_tweet').value;
     const tweet = document.getElementById('tweet').value;
     let note = topic + ": " + tweet;
     if(topic == ""){
          note = tweet;
     }
     if(tweet == ""){
          console.log("empty");
          alert("To save massage you should write at least tweet.");
     }
     else{
          ...
          addTweetLocalStorage(tweet,topic);
...
function addTweetLocalStorage(tweet,topic) {
